...
// PR856818 by xing.zhao  [CTS Verifier 4.4_r3] Alarms and Timers Tests #com.android.cts.verifier.deskclock.DeskClockTestsActivity   begin
            if(intent.hasExtra("CountDownTitleShow")){
                String message = intent.getStringExtra("CountDownTitleShow");
                mmessage = message;
            }
// PR856818 by xing.zhao  [CTS Verifier 4.4_r3] Alarms and Timers Tests #com.android.cts.verifier.deskclock.DeskClockTestsActivity   begin
			if (timeCount <= 0) {
...
// PR856818 by xing.zhao  [CTS Verifier 4.4_r3] Alarms and Timers Tests #com.android.cts.verifier.deskclock.DeskClockTestsActivity   begin
                    Intent fireAlarm = new Intent(BackgroundCountDownService.this,CountDownAlarmAlert.class);
                    if(mmessage.equals("Start Timer Test")){
                        fireAlarm.putExtra("CountDownTitle", mmessage);
                        mmessage = "";
                    }
// PR856818 by xing.zhao  [CTS Verifier 4.4_r3] Alarms and Timers Tests #com.android.cts.verifier.deskclock.DeskClockTestsActivity   begin
