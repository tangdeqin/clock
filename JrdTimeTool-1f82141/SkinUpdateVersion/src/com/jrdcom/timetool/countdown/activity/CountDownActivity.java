...
public class CountDownActivity extends Activity {
    ...
    // PR856818 by xing.zhao  [CTS Verifier 4.4_r3] Alarms and Timers Tests #com.android.cts.verifier.deskclock.DeskClockTestsActivity   begin
    private int mflag = 0;
    private int mflagback = 0;
    // PR856818 by xing.zhao  [CTS Verifier 4.4_r3] Alarms and Timers Tests #com.android.cts.verifier.deskclock.DeskClockTestsActivity   begin
...
// PR856818 by xing.zhao  [CTS Verifier 4.4_r3] Alarms and Timers Tests #com.android.cts.verifier.deskclock.DeskClockTestsActivity   begin
        ...
        final int second = intent.getIntExtra("CountDownSecend", 0);
        if(intent != null && second != 0){
            mflag = 1;
            mflagback = 1;
            HOUR = 0;
            MINUTE = 0;
            ...
            mCountDownPicker.setCurrentMinute(MINUTE);
            mCountDownPicker.setCurrentSecond(SECOND);
            mCountDownPicker.invalidate();
            TextView CountdownTitle = (TextView) findViewById(R.id.activity_timer);
            CountdownTitle.setText("Start Timer Test");
        }
// PR856818 by xing.zhao  [CTS Verifier 4.4_r3] Alarms and Timers Tests #com.android.cts.verifier.deskclock.DeskClockTestsActivity   begin
...
// PR856818 by xing.zhao  [CTS Verifier 4.4_r3] Alarms and Timers Tests #com.android.cts.verifier.deskclock.DeskClockTestsActivity   begin
        if(mflag == 1){
            timerServiceIntent.putExtra("CountDownTitleShow","Start Timer Test");
            mflag = 0;
        }
// PR856818 by xing.zhao  [CTS Verifier 4.4_r3] Alarms and Timers Tests #com.android.cts.verifier.deskclock.DeskClockTestsActivity   begin
        startService(timerServiceIntent);
