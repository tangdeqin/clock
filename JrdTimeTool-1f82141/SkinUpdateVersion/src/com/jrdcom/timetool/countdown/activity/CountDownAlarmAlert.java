...
// PR856818 by xing.zhao  [CTS Verifier 4.4_r3] Alarms and Timers Tests #com.android.cts.verifier.deskclock.DeskClockTestsActivity   begin
        ...
        if(intent.hasExtra("CountDownTitle")){
            String message = intent.getStringExtra("CountDownTitle");
            if(message.equals("Start Timer Test")){
               TextView AlertLabel = (TextView) findViewById(R.id.timer_alert_label);
