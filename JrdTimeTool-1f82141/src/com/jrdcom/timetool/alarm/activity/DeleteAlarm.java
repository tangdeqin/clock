...
public class DeleteAlarm extends Activity implements
    ...
    private BroadcastReceiver screenOffReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if(action.equals(Intent.ACTION_SCREEN_OFF) || 
					...
					action.equals(Alarms.ALARM_ALERT_ACTION)){// PR695264-Neo Skunkworks-kehao.wei-001 add
				mIsScreenOff = true;
			}
    ...
    public void onResume() {
        super.onResume();
        MyLog.debug("onResume of Delete is called.--",
        ...
        alertBuilder.setPositiveButton(R.string.worldtime_ok,
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        while (position >= 0) {
                            Cursor c = (Cursor) mAlarmList.getAdapter()
                                    .getItem(position);
    ...
    private class AlarmAdapter extends CursorAdapter {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            DigitalClock digitalClock = (DigitalClock) view
                    .findViewById(R.id.alarm_digitalClock);
            ...
            CheckBox selectCheckBox = (CheckBox) view
                    .findViewById(R.id.alarm_select_check_box);
            /*PR 570245- Neo Skunkworks - Paul Xu modified - 001 Begin*/
			/*
			...
			*/
            ...
            Button deleteButton = (Button) DeleteAlarm.this
                    .findViewById(R.id.alarm_delete);
			/*PR 570245- Neo Skunkworks - Paul Xu modified - 001 Begin*/
			/*
        ...
        public View newView(Context context, Cursor cursor, ViewGroup parent) {
            return LayoutInflater.from(DeleteAlarm.this).inflate(
                    R.layout.alarm_delete_listitem, parent, false);
        }
