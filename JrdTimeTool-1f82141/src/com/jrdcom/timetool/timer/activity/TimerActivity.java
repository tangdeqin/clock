...
public class TimerActivity extends Activity {
    ...
    // add by Liujanmin for PR 778417 begin
    private boolean mLoadDataFromSharedPref = false;

    private static final String NEED_LOAD_DATA = "time.needloaddata";
    // add by Liujanmin for PR 778417 end
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // modify by Liujanmin for PR 778417 begin
        SharedPreferences sharedPre = getSharedPreferences(TIMER_RPREFERENCES, MODE_PRIVATE);
        Boolean isNeedLoadData = sharedPre.getBoolean(NEED_LOAD_DATA, false);
        if (true == isNeedLoadData) {
        ...
        // modify by Liujanmin for PR 778417 end
    }
    ...
    protected void onDestroy() {
        ...
        if (findViewById(R.id.Timer_stop).getVisibility() == View.VISIBLE) {
            mLoadDataFromSharedPref = true;
        } else {
            mLoadDataFromSharedPref = false;
        }
        Log.i(TAG, String.valueOf(findViewById(R.id.Timer_stop).getVisibility() == View.VISIBLE));
        Log.i(TAG, String.valueOf(mLoadDataFromSharedPref));
        // add by Liujanmin for PR 778417 end
    ...
    public void stopTimer(boolean isFinish) {
        ...
        // delete by Liujanmin for PR 778417 begin
//        stopService(new Intent(this, EmptyService.class));
        // delete by Liujanmin for PR 778417 end
    }
    ...
    public void writeTimerLog() {
    	...
    	// add by Liujanmin for PR 778417 begin
    	editor.putBoolean(NEED_LOAD_DATA, mLoadDataFromSharedPref);
    	// add by Liujanmin for PR 778417 end
