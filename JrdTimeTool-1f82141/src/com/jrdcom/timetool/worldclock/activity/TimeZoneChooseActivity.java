    ...
    private class ChooseListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (timeZoneInfo.isShow
                ...
                gmtView.setEnabled(false);
                gmtView.setTextColor(Color.GRAY);
            } else {
                isShowed.setVisibility(View.GONE);
                displayNameView.setEnabled(true);
                displayNameView.setTextColor(Color.WHITE);
                gmtView.setEnabled(true);
                gmtView.setTextColor(Color.WHITE);
            }
