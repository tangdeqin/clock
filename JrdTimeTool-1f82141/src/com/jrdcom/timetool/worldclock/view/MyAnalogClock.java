...
public class MyAnalogClock extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        //add FR450182 add xibin start -- add xxhdpi drawable resources for wave2 projects.
//        if (TimeToolActivity.getScreenResolutionWidth() == 1080) {
//            dial.setBounds(x - (w / 2), y + 45 - (h / 2), x + (w / 2), y + 45
//                    + (h / 2));
//        } else
//
//        if (TimeToolActivity.getScreenResolutionWidth() == 720) {
//            dial.setBounds(x - (w / 2), y + 30 - (h / 2), x + (w / 2), y + 30
//                    + (h / 2));
//        } else if (TimeToolActivity.getScreenResolutionWidth() == 320) {
//            dial.setBounds(x - (w / 2), y + 15 - (h / 2), x + (w / 2), y + 15
//                    + (h / 2));
//        }else if (TimeToolActivity.getScreenResolutionWidth() == 1440) {
//            dial.setBounds(x - (w / 2), y + 60 - (h / 2), x + (w / 2), y + 60
//                    + (h / 2));
//        }
//        
//        else {
//            dial.setBounds(x - (w / 2), y + 25 - (h / 2), x + (w / 2), y + 25
//                    + (h / 2));
//        }
        //add FR450182 add xibin end
        ...
        minutehandShadow
                .setBounds(x - (w / 2) + offsetX, y - (h / 2) + offsetY, x + (w / 2) + offsetX, y
                        + (h / 2) + offsetY);
