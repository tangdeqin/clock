...
public class TimeToolActivity extends TabActivity {
	...
	RelativeLayout myTab0;
	TextView myText0;
	ImageView img0;
	RelativeLayout myTab1;
	TextView myText1;
	ImageView img1;
	RelativeLayout myTab2;
	TextView myText2;
	ImageView img2;
	RelativeLayout myTab3;
	TextView myText3;
	ImageView img3;
	...
	private void getScreenResolution() {
		...
		android.util.Log.e("aa", "shit-->SCREEN_WIDTH=" + SCREEN_WIDTH + ";;SCREEN_HEIGHT=" + SCREEN_HEIGHT);
	}
	...
	private void initChildActivity() {
		myTab0 = (RelativeLayout) LayoutInflater.from(this).inflate(R.layout.tab_widget, null);
		myTab0.setBackgroundDrawable(getResources().getDrawable(
				R.drawable.tab_choose));
		myText0 =(TextView)myTab0.findViewById(R.id.tab_label);
		myText0.setText(R.string.activity_worldclock);
		myText0.setTextColor(Color.WHITE);
		...
		myTab3 = (RelativeLayout) LayoutInflater.from(this).inflate(R.layout.tab_widget, null);
