...
//                | WindowManager.LayoutParams.FLAG_DISMISS_KEYGUARD
	...
	private void startAlert() {
     ...
     // modify Yanjingming for PR464456 end
        ...
        SharedPreferences sharedPre = getSharedPreferences(CountDownActivity.TIMER_RPREFERENCES,
                MODE_PRIVATE);
        String ringtonePath = sharedPre.getString(CountDownActivity.ALERT_RINGTONE_PATH_KEY,
                CountDownActivity.ALERT_SILENT_PATH);

        if (!CountDownActivity.ALERT_SILENT_PATH.equals(ringtonePath) && !isRinging) {// modify Yanjingming for PR464456
