...
import com.tct.deskclock.libs.TctMountService;
import com.tct.deskclock.libs.TctStorageManager;
import com.tct.deskclock.libs.TctSystemProperties;
import com.tct.deskclock.libs.TctUserHandle;
...
public class PowerOffAlarm {
    ...
    static boolean bootFromPoweroffAlarm() {
        ...
        String bootReason = TctSystemProperties.get("sys.boot.reason");
    ...
    public static int getPasswordType() {
        /*int type = TctStorageManager.CRYPT_TYPE_PASSWORD;
        ...
        return TctMountService.getPasswordType();
    }

    // Whether the device was Unencrypted.
    static boolean deviceUnencrypted() {
        return "unencrypted".equals(TctSystemProperties.get("ro.crypto.state"));
    ...
    public static boolean canEnablePowerOffAlarm() {
        boolean enabled = (TctUserHandle.myUserId() == TctUserHandle.USER_OWNER)
                && (deviceUnencrypted() || TctStorageManager.CRYPT_TYPE_DEFAULT == getPasswordType());
