    ...
    private static class RingtonePlaybackDelegate implements PlaybackDelegate {
        ...
        public void play(Context context, Uri ringtoneUri, boolean inCall) {
            ...
            if (mRingtone == null
                ...
                // add by kangsen.chen for defect 3648970 2016-1206 begin
                // Attempt to enable looping the ringtone.
                try {
                    mSetLoopingMethod.invoke(mRingtone, true);
                    LogUtils.i("chenks  2: mSetLoopingMethod.invoke");
                } catch (Exception e) {
                    LogUtils.e(TAG, " Unable to turn looping on for android.media.Ringtone", e);
                }
                // add by kangsen.chen for defect 3648970 2016-1206 end
            }
            ...
            if (inTelephoneCall) {
                ...
                //modified by kai.chen for defect 4706011
                Log.e("kaikai",Thread.currentThread().toString());
                while (AudioManager.AUDIOFOCUS_GAIN != mAudioManager.requestAudioFocus(null, AudioManager.STREAM_ALARM,
                    AudioManager.AUDIOFOCUS_GAIN_TRANSIENT)) {
                    mAudioManager.requestAudioFocus(null, AudioManager.STREAM_ALARM,
                            AudioManager.AUDIOFOCUS_GAIN_TRANSIENT);
                }
