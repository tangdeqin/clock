...
import android.provider.Settings; // add by junye.li for defect 2265092
...
public class TimerAlertFullScreen extends BaseActivity implements OnEmptyListListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // modify by junye.li for defect 2265092 begin
        int sleepTimeOut = Settings.Secure.getInt(getContentResolver(), "sleep_timeout",
                60 * 1000);
        if (sleepTimeOut < 0) { // when sleep timeout is never, should not lock while screen on
        ...
        // modify by junye.li for defect 2265092 end
