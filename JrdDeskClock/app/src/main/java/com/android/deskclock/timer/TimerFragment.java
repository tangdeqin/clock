...
public class TimerFragment extends DeskClockFragment implements OnSharedPreferenceChangeListener {
            ...
            for (int i = 0; i < mAdapter.getCount(); i++) {
                ...
                if (toggle && t.mView != null) {
                    ...
                    if (t.mState == TimerObj.STATE_STOPPED) {
                        ...
                        //add by kangsen.chen for defect 2570833 2016-0725 begin
                        final ImageButton resetButton = (ImageButton)
                                t.mView.findViewById(R.id.reset_add);
                        final boolean canReset = true;
                        resetButton.setEnabled(canReset);
                        //add by kangsen.chen for defect 2570833 2016-0725 end
                    }
                }
            }
    ...
    public void onResume() {
        ...
        //add by kangsen.chen for defect 2016-1128 begin
        if ( mAdapter.getCount() != 0 ){
            long curTime = Utils.getTimeNow();
            TimerObj tempTimerObj;
            tempTimerObj = (TimerObj)mAdapter.getTimerAt(0);
            if ( tempTimerObj != null && curTime < tempTimerObj.mStartTime ) {
                LogUtils.w("Phone has been reboot !");
                mAdapter.deleteAllTimers();
                mAdapter.notifyDataSetChanged();
            }
        }
        //add by kangsen.chen for defect 2016-1128 end
        ...
        if (newIntent != null
            ...
            goToSetUpView = true;
            //added by kai.chen for defect 4622930 on 2017-04-26 begin
            if(mSetupView != null && mViewState != null) {
                mSetupView.restoreEntryState(mViewState, KEY_ENTRY_STATE);
            }
            //added by kai.chen for defect 4622930 on 2017-04-26 end
...
//        }
    ...
    public void onFabClick(View view) {
        if (mLastView != mTimerView) {
            //add by yeqing.lv for defect 5065267 at 2017-7-19 begin
            if(Utils.isFastDoubleClick()){
                return;
            }
            //add by yeqing.lv for defect 5065267 at 2017-7-19 end
    ...
    public void setLabel(TimerObj timer, String label) {
         ...
         */
    	// remove by fan.yang for defect 1176191 start
...
//            return;
//        }
    	// remove by fan.yang for defect 1176191 end
