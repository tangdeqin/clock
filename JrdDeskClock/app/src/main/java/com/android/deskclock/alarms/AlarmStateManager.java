...
import com.tct.deskclock.libs.TctAlarmManager;
...
public final class AlarmStateManager extends BroadcastReceiver {
    ...
    private static void updateParentAlarm(Context context, AlarmInstance instance) {
        ...
        if (!alarm.daysOfWeek.isRepeating()) {
            ...
            // modify by junye.li for defect 2359434 begin
           /* Calendar currentTime = getCurrentTime();
            if (instance.getAlarmTime().after(currentTime)) {
                currentTime = instance.getAlarmTime();
            }*/
            ...
            // modify by junye.li for defect 2359434 end
    ...
    private static class AlarmManagerStateChangeScheduler implements StateChangeScheduler {
        ...
        public void cancelScheduledInstanceStateChange(Context context, AlarmInstance instance) {
            ...
            if (pendingIntent != null) {
                ...
                //ReflectUtil.invokeMethod(am, "cancelPoweroffAlarm", new Class[]{String.class},
                //        new Object[]{context.getPackageName()});
                //am.cancelPoweroffAlarm(context.getPackageName());
                ///@}
                TctAlarmManager.getInstance().cancelPoweroffAlarm(context, context.getPackageName());
     ...
     * @param context application context
     * @param nextAlarm alarm instance
     */
