...
public class StopwatchFragment extends DeskClockFragment
    ...
    public void onResume() {
        ...
        //add by junye.li for defect 1239263 begin
        long curTime = Utils.getTimeNow();
        if (curTime < mStartTime) {
            LogUtils.w("Phone has been reboot !");
            doReset();
        }
        //add by junye.li for defect 1239263 end
    ...
    public void setLeftRightButtonAppearance() {
        ...
        switch (mState) {
            case Stopwatches.STOPWATCH_RESET:
                ...
                break;
            case Stopwatches.STOPWATCH_RUNNING:
            	// modify by fan.yang defect 1177083 start
            	if (reachedMaxLaps()) {
            		mLeftButton.setImageResource(R.drawable.ic_lap_gray);
            	} else {
            		mLeftButton.setImageResource(R.drawable.ic_lap);
            	}
            	// modify by fan.yang defect 1177083 end
                mLeftButton.setContentDescription(getString(R.string.sw_lap_button));
