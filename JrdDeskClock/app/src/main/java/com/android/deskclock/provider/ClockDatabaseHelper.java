...
import com.android.deskclock.R; // add by junye.li for defect 1240243
...
class ClockDatabaseHelper extends SQLiteOpenHelper {
    ...
    // add by junye.li for defect 1240243 begin
    private static final String DEFAULT_ALARM_1_CUSTOM = "(8, 30, 79, 0, 0, '', NULL, 0);";
    // add by junye.li for defect 1240243 end

    // This creates a default alarm at 9:30 for every Sat,Sun
    private static final String DEFAULT_ALARM_2 = "(9, 00, 96, 0, 0, '', NULL, 0);";
    // add by junye.li for defect 1240243 begin
    private static final String DEFAULT_ALARM_2_CUSTOM = "(9, 00, 48, 0, 0, '', NULL, 0);";
    // add by junye.li for defect 1240243 end
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // modify by junye.li for defect 1240243 begin
        // modify by junye.li for defect 2474322 begin
        if ("-1".equals(mContext.getResources().getString(R.string.def_alarm_firstdayOfWeek))
                || "2".equals(mContext.getResources().getString(R.string.def_alarm_firstdayOfWeek))) {
        // modify by junye.li for defect 2474322 end
            db.execSQL(insertMe + DEFAULT_ALARM_1);
            db.execSQL(insertMe + DEFAULT_ALARM_2);
        } else {
            db.execSQL(insertMe + DEFAULT_ALARM_1_CUSTOM);
            db.execSQL(insertMe + DEFAULT_ALARM_2_CUSTOM);
        }
        // modify by junye.li for defect 1240243 end
    }
