...
import com.tct.deskclock.libs.TctNotification;
...
public class AlarmService extends Service {
    ...
    private void startAlarmKlaxon(AlarmInstance instance) {
        ...
        // add by junye.li for defect 2359434 begin
        Notification.Builder builder = new Notification.Builder(this);
        builder.setSmallIcon(R.drawable.stat_notify_alarm);
        Notification notification = builder.build();
        // add by junye.li for defect 2359434 end
        notification.flags |= TctNotification.FLAG_HIDE_NOTIFICATION;
